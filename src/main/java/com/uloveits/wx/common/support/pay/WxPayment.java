package com.uloveits.wx.common.support.pay;
...
import com.uloveits.wx.common.utils.HashUtil;
import com.uloveits.wx.common.utils.StringUtil;
import com.uloveits.wx.common.utils.XmlUtil;
...
public class WxPayment {
    ...
    public static Map<String, String> buildRefundParams(String appid, String mch_id, String sub_appid,
                                                        ...
                                                        String refund_fee, String refund_fee_type, String refund_account, String refund_desc, String paternerKey,String notify_url) {
        Map<String, String> params = new HashMap<String, String>();
        params.put("appid", appid);
        params.put("mch_id", mch_id);
        params.put("sub_appid", sub_appid);
    ...
    public static boolean codeIsOK(String return_code) {
        return StringUtil.isNotBlank(return_code) && "SUCCESS".equals(return_code);
    }
    ...
    public static Map<String, String> buildOrderPaySign(String appId, String partnerId, String prepayId,
                                                        String tradeType, String partnerKey) {
        Map<String, String> params = new HashMap<String, String>();
