...
public class WxPay {
    ...
    public static String closeOrder(String orderId) {
        ...
        params.put("appid",Resources.THIRDPARTY.getString("app_id_wx"));
        params.put("mch_id", Resources.THIRDPARTY.getString("mchid"));
        params.put("out_trade_no", orderId);
        params = WxPayment.buildSignAfterParasMap(params, Resources.THIRDPARTY.getString("mch_Key"));
